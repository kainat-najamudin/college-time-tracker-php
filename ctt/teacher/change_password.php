...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Password FROM Teacher WHERE TeacherID = $uid"));
    ...
    if ($user['Password'] !== $old) {
        ...
        $hashed = md5($new);
        $sql = "UPDATE Teacher SET Password = '$hashed' WHERE TeacherID = $uid";
    ...
    <div class="page-header">
        <div class="page-title">
            <div class="breadcrumb-custom">
                ...
                <i class="fas fa-chevron-right"></i> Change Password
            </div>
        ...
        <div class="col-lg-5">
            <div class="form-card">
                <div class="text-center mb-4">
                    <div style="width:64px;height:64px;border-radius:50%;background:linear-gradient(135deg,#1e40af,#3b82f6);color:#fff;font-size:1.6rem;display:flex;align-items:center;justify-content:center;margin:0 auto 0.8rem;">
