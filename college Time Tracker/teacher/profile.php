...
$user = fetch_all("SELECT * FROM teacher WHERE TeacherID=$uid")[0] ?? [];
$success = $error = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email)) {
        ...
        $designation_s = mysqli_real_escape_string($conn, $designation);
        if (mysqli_query($conn, "UPDATE teacher SET Name='$name_s', Email='$email_s', Department='$department_s', Designation='$designation_s' WHERE TeacherID=$uid")) {
...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="data-card text-center">
            ...
            <span style="background:#f0fdf4;color:#059669;padding:5px 16px;border-radius:50px;font-size:0.82rem;font-weight:700;">
                <i class="fa-solid fa-chalkboard-teacher me-1"></i>Teacher
            </span>
            ...
            <div class="mt-2 p-3 text-start bg-light rounded">
                ...
                <div class="fw-bold"><?= h($user['Designation'] ?? 'Not Set') ?></div>
            </div>
            <div class="mt-2 p-3 text-start bg-light rounded">
    ...
    <div class="col-lg-8">
        <div class="data-card">
            <h5 class="fw-bold mb-4"><i class="fa-solid fa-pen-to-square me-2 text-primary"></i>Edit Profile Information</h5>
            <form method="POST">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="designation" class="form-control" value="<?= h($user['Designation'] ?? '') ?>">
                    </div>
                    <div class="col-md-6">
